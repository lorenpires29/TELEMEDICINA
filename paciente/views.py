...
from medico.models import DadosMedico, DatasAbertas, Especialidades, DatasAbertas, is_medico
...
#TODO: Criar as demais validações de segurança
#TODO: Criar botão para o paciente cancelar a consulta